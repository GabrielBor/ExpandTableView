...
- (NSString *) labelTotalFriendsCellAtIndex:(NSInteger) parentIndex;
- (NSString *) labeYearCellAtIndex:(NSInteger) parentIndex;
- (NSString *) labeQtFriendsCellAtIndex:(NSInteger) parentIndex;
...
- (NSString *) labelDateAndHourChildIndex:(NSInteger) childIndex withinParentCellIndex:(NSInteger) parentIndex;
